...
<form method="post" 
	<center		<h1>Test Risiko Covid-19</h1>
	</center>
	<table cellspacing="0">
		<thead>
			<tr>
...
<body>
		...
		<tbody>
			<tr>
				...
				<td>
					<input type="radio" name="1" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="1" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>2</td>
				...
				<td>
					<input type="radio" name="2" value="1" required>Ya
				<td>
					<input type="radio" name="2" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>3</td>
				...
				<td>
					<input type="radio" name="3" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="3" value="0" required>Tidak
				</td>
			</tr>
		    <tr>
				<td>4</td>
				...
				<td>
					<input type="radio" name="4" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="4" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>5</td>
				...
				<td>
					<input type="radio" name="5" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="5" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>6</td>
				...
				<td>
					<input type="radio" name="6" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="6" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>7</td>
				...
				<td>
					<input type="radio" name="7" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="7" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>8</td>
				...
				<td>
					<input type="radio" name="8" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="8" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>9</td>
				...
				<td>
					<input type="radio" name="9" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="9" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>10</td>
				...
				<td>
					<input type="radio" name="10" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="10" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>11</td>
				...
				<td>
					<input type="radio" name="11" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="11" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>12</td>
				...
				<td>
					<input type="radio" name="12" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="12" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>13</td>
				...
				<td>
					<input type="radio" name="13" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="13" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>14</td>
				...
				<td>
					<input type="radio" name="14" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="14" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>15</td>
				...
				<td>
					<input type="radio" name="15" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="15" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>16</td>
				...
				<td>
					<input type="radio" name="16" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="16" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>17</td>
				...
				<td>
					<input type="radio" name="17" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="17" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>18</td>
				...
				<td>
					<input type="radio" name="18" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="18" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>19</td>
				...
				<td>
					<input type="radio" name="19" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="19" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>20</td>
				...
				<td>
					<input type="radio" name="20" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="20" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td>21</td>
				...
				<td>
					<input type="radio" name="21" value="1" required>Ya
				</td>
				<td>
					<input type="radio" name="21" value="0" required>Tidak
				</td>
			</tr>
			<tr>
				<td colspan="2"> 
